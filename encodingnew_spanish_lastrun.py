...
expName = 'encoding new'  # from the Builder filename that created this script
expInfo = {'participant': ''}
...
filename = _thisDir + os.sep + u'encoding/%s_%s_%s' % (expInfo['participant'], expName, expInfo['date'])

# An ExperimentHandler isn't essential but helps with data saving
thisExp = data.ExperimentHandler(name=expName, version='',
    extraInfo=expInfo, runtimeInfo=None,
    originPath='/Users/leallab/Library/CloudStorage/Box-Box/Leal Lab/Studies/In-Person Study Folders/122_LatinoHealth/SPANISH/EPS_New_A_Spanish/encodingnew_spanish_lastrun.py',
...
Instructions = visual.TextStim(win=win, name='Instructions',
    text='Se le mostrará una serie de imágenes y se le pedirá que haga algunos juicios sobre ellas. Debe calificar las imágenes que aparezcan en la pantalla según su contenido emocional. \n\nUtilizará una escala del 1 al 9, siendo 1 lo más negativo, 9 lo más positivo y 5 una imagen neutral. \n\nLas imágenes estarán en la pantalla por 3 segundos. Asegúrese de indicar sus opciones mientras la imagen aún está en la pantalla.\n\nPresione la barra de espacio para ver ejemplos.',
    font='Arial',
...
Valence_rating_slider = visual.Slider(win=win, name='Valence_rating_slider',
    ...
    labels=("Negativo", None, None, None,"Neutral", None, None, None, "Positivo"), ticks=(1,2,3,4,5,6,7,8,9), granularity=0.0,
...
start_screen = visual.TextStim(win=win, name='start_screen',
    text='Ahora comenzará la prueba. Esto debería tomar alrededor de 10 minutos.\n\n¿Alguna pregunta?\n\nPresione la barra de espacio para comenzar.',
    font='Arial',
...
endtext = visual.TextStim(win=win, name='endtext',
    text='FIN DE LA PARTE 1\n\nPor favor, llame a su experimentador.\n\nGRACIAS',
    font='Arial',
...
trials = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('example_encoding.xlsx', selection='0:4'),
...
task = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('encodingtask1.xlsx', selection='0:136'),
    seed=None, name='task')
...
for thisTask in task:
    ...
    # keep track of which components have finished
    testComponents = [Stimuli, emotional_valence_slider]
