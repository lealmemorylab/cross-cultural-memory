...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/leallab/Desktop/Study 122/English/New Task/encodingnew_lastrun.py',
...
Instructions = visual.TextStim(win=win, name='Instructions',
    text='You will be shown a series of images and asked to make some judgements about them\n\nUse the slider to indicate if the image is negative, neutral, or positive.\n\nImages will be on screen for 3 secs \n\nMake sure that you indicate your choices while the image is still on the screen.\n\nPress the space bar for examples',
    font='Arial',
...
for thisComponent in Start_ScreenComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('start_screen.started', start_screen.tStartRefresh)
thisExp.addData('start_screen.stopped', start_screen.tStopRefresh)
# check responses
