...
expName = 'retrieval_new_SPANISH'  # from the Builder filename that created this script
expInfo = {'participant': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/fernanda/Library/CloudStorage/Box-Box/Leal Lab/Studies/In-Person Study Folders/122_LatinoHealth/SPANISH/EPS_New_A_Spanish/retrieval_new_SPANISH_lastrun.py',
...
text_6 = visual.TextStim(win=win, name='text_6',
    text='Ahora examinaremos su memoria de las imágenes que vio anteriormente.\n\nV = Exactamente igual\nN = Nuevo / Diferente\n\nLas imagenes estarán en la pantalla por 3 segundos. Asegúrese de responder mientras las imagenes estén en la pantalla.\n\nPresione la barra de espaciado para ver ejemplos.',
    font='Arial',
...
text = visual.TextStim(win=win, name='text',
    text='Imagínese que esta es una imagen que vio anteriorment.',
    font='Arial',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='V = EXACTAMENTE IGUAL   N = NUEVO / DIFERENTE',
    font='Arial',
...
instructions = visual.TextStim(win=win, name='instructions',
    text='Puede tomar un breve descanso\n\nLas instrucciones son las mismas\n\nV = Exactamente igual\nN = Nuevo/ Diferente\n\nPresione la barra de espacio para continuar',
    font='Arial',
